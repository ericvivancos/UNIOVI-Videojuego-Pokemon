...
Game::Game() {
	...
	SDL_SetWindowTitle(window, "Pokemon Adventures");
	...
	battleLayer = new BattleLayer(this);
	Pokemon* wildPokemon = Pokemon::generateRandomPokemon(this);
	...
	// fuentes
	TTF_Init();
	font = TTF_OpenFont("resoruces/fonts/pokemon-ds-font.ttf", 36);
